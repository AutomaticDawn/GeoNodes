...
const val GPS_LATITUDE = "latitude" // Obavezno promeniti i dodati ovo u konstante !!!
const val GPS_LONGITUDE = "longitude" // Obavezno promeniti i dodati ovo u konstante !!!